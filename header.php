<!DOCTYPE html>
 <html lang="pt_BR"> 
    ...
    <!-- Bootstrap core CSS -->
      ...
      <script type="text/javascript" src="/es/assets/js/bootstrap.js"></script>
      <script type="text/javascript" src="/es/assets/js/jquery-1.11.2.js"></script>
	  </head>
            ...
            <div class="row-fluid">
              <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar lead">
                  ...
                  <li><a href="/es/view/estagio/index.php">Estágio</a></li>
              ...
              else
              {
                ...
                <script type="text/javascript">window.setInterval(function() {window.location.replace("/es/index.php");}, 1000);
                </script> 
                <?php
                 die();
              }
